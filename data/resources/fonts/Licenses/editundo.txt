...
Edit Undo  Created by Brian Kent
¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯

Thanks for Downloading Edit Undo.
...
-Edit Undo      [10pt] [.fon]
-Edit Undo Line [18pt] [.fon]
-Edit Undo Dot  [18pt] [.fon]

  editundo.fon, edunline.fon and edundot.fon are Windows Bitmap Fonts
(.fon).  These fonts are best used at the point sizes shown above.
To use it at larger point sizes (for images), try using a graphics
program like Photoshop, Paint Shop Pro, or the Paint program that
comes with Windows.  Type out your text at the recommended point size
(shown above), then resize the image.   Set the color mode to 256
