...
True Type Font: Mini Pixel-7 version 1.0


EULA
-==-
The font Mini Pixel-7 is freeware for home using only.


DESCRIPTION
-=========-
Original proportional small pixel font. Native size is 15 points. Cyrillic code page is supported.

Files in mini_pixel-7.zip:
       	readme.txt     			this file.
        mini_pixel-7.ttf    		regular true type font;
	mini_pixel-7.fon   		font in Windows OS "FON";
	mini_pixel-7_screen.png		preview image.
