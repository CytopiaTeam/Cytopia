...
struct ImVec2
{
    ...
    explicit inline ImVec2(const ImVec2Scaled &o);
...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginCt(const char *name, bool *p_open = NULL, ImGuiWindowFlags flags = 0);
    IMGUI_API void          End();
    ...
    IMGUI_API bool          ButtonCt(const char* label, const ImVec2& size_arg = ImVec2(0, 0));
    ...
    IMGUI_API bool          BeginComboCt(const char *label, const char *preview_value, ImGuiComboFlags flags = 0);
    ...
    IMGUI_API bool          SliderFloatCt(const char *label, float *v, float v_min, float v_max, const char *format = "%.3f", ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          SliderScalarCt(const char *label, ImGuiDataType data_type, void *p_data, const void *p_min, const void *p_max, const char *format, ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          InputTextCt(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    ...
    IMGUI_API bool          InputScalarCt(const char* label, ImGuiDataType data_type, void* p_data, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0);
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_CtBackground           = 1 << 29,  // Render Window with cytopia rules
...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_CtBackground        = 1 << 20,
    ImGuiInputTextFlags_ButtonsOnly         = 1 << 21
...
enum ImGuiCol_
{
    ...
    ImGuiCol_SliderCtGrab,
    ImGuiCol_SliderCtGrabActive,
    ImGuiCol_COUNT
};
...
enum ImGuiStyleVar_
{
    ...
    ImGuiStyleVar_FrameCtBorderSize,   // float     FrameCtBorderSize
    ImGuiStyleVar_COUNT
};
...
enum ImGuiSliderFlags_
{
    ...
    ImGuiSliderFlags_NoText                 = 1 << 8,       // Disable CTRL+Click or Enter key allowing to input text directly into the widget
...
struct ImGuiStyle
{
    ...
    ImVec2      FrameButtonPaddingCt;       // Padding within a button cytopia rectangle (used by old style button).
...
{
  template<class T>
  inline ImVec2 ImVec2Scaled(T x, T y) { return ImVec2{ x * ImGui::GetIO().FontGlobalScale, y * ImGui::GetIO().FontGlobalScale }; }
  inline ImVec2 ImVec2Scaled(const ImVec2 &o) { return ImVec2{ o.x * ImGui::GetIO().FontGlobalScale, o.y * ImGui::GetIO().FontGlobalScale }; }
}
