...
Point Resources::convertScreenToIsoCoordinates(Point screenCoordinates, bool calcWithoutOffset)
{
  ...
  {
    //isoCoordinates = vectorMatrix::in
    //Engine& engine = Engine::Instance();
    //Engine& Engine = Engine::Instance();
    isoCoordinates = Engine::Instance().findCellAtCoords(screenCoordinates);
    std::cout << "I AM CALLED";
    std::cout << "with coords: " << screenCoordinates.getX() << screenCoordinates.getY() << std::endl;
