...
template <typename Range, typename... Ranges>
ZipRange<Iterator, Iterators...>::
ZipRange(Range && r1, Ranges && ... ranges) :
...
template <typename Range, typename... Ranges>
ZipRange<Iterator, Iterators...>::
ZipRange(const Range && r1, const Ranges && ... ranges)
{
  static_assert(sizeof(Range) < 0, 
      "You cannot construct a ZipRange from temporary containers");
}
