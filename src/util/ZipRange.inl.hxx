...
template <typename Iterator, typename... Iterators>
typename ZipRange<Iterator, Iterators...>::ZipIterator ZipRange<Iterator, Iterators...>::begin()
{
  return m_Begin;
}

template <typename Iterator, typename... Iterators>
typename ZipRange<Iterator, Iterators...>::ZipIterator ZipRange<Iterator, Iterators...>::end()
{
  return m_End;
}
