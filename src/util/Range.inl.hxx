...
Range<Iterator>::Range(Container& ctn) :
    m_Begin(ctn.begin()), m_End(ctn.end()) { }
  
template <typename Iterator>
template <typename Container>
Range<Iterator>::Range(const Container&&)
{
...
template <typename Iterator>
Iterator Range<Iterator>::begin() { return m_Begin; }
  
template <typename Iterator>
Iterator Range<Iterator>::end() { return m_End; }
