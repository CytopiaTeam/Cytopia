...
template <typename Iterator> typename Range<Iterator>::iterator Range<Iterator>::begin() { return m_Begin; }

template <typename Iterator> typename Range<Iterator>::iterator Range<Iterator>::end() { return m_End; }
