...
#ifdef USE_AUDIO
  /* All AudioEvents */
  struct AudioTriggerEvent, struct AudioTrigger3DEvent, 
  struct AudioTriggerReverbEvent, struct AudioTriggerReverb3DEvent,
  struct AudioTriggerEchoEvent, struct AudioTriggerEcho3DEvent, 
  struct AudioPlayEvent, struct AudioPlay3DEvent, 
  struct AudioPlayReverbEvent, struct AudioPlayReverb3DEvent,
  struct AudioPlayEchoEvent, struct AudioPlayEcho3DEvent,
