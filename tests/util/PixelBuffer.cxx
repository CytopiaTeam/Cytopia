...
TEST_CASE("I can crop PixelBuffers", "[util]")
{
  ...
  const std::vector<uint32_t> pixels{0xFF0000FF, 0x00FF00FF, 0x0000FFFF, 0xFFFFFFFF};
...
TEST_CASE("I can expand PixelBuffers", "[util]")
{
  ...
  std::array pixels_odd{
      0xFFFFFFFF_rgba, 0x0000FFFF_rgba, 0xFFFFFFFF_rgba, 0x0000FFFF_rgba, 0x0000FFFF_rgba,
      0x0000FFFF_rgba, 0xFFFFFFFF_rgba, 0x0000FFFF_rgba, 0xFFFFFFFF_rgba,
  };
  PixelBuffer pb3(Rectangle{0, 0, 2, 2}, pixels_odd);
  std::array<uint32_t, 16> expected_odd{
      0xFFFFFFFF_rgba, 0x0000FFFF_rgba, 0x0000FFFF_rgba, 0xFFFFFFFF_rgba, 0x0000FFFF_rgba, 0x0000FFFF_rgba,
      0x0000FFFF_rgba, 0x0000FFFF_rgba, 0x0000FFFF_rgba, 0x0000FFFF_rgba, 0x0000FFFF_rgba, 0x0000FFFF_rgba,
      0xFFFFFFFF_rgba, 0x0000FFFF_rgba, 0x0000FFFF_rgba, 0xFFFFFFFF_rgba,
  };
...
TEST_CASE("I can recolor PixelBuffers", "[util]")
{
  ...
  const std::array<uint32_t, 5> expected_grayscales{0x171717FF_rgba, 0x464646FF_rgba, 0xCCCCCCFF_rgba, 0xE5E5E5FF_rgba,
                                                    0xF7F7F7FF_rgba};
  ...
  const std::array<uint32_t, 5> expected_purples{0xe82828ff_rgba, 0x343232ff_rgba, 0x340000ff_rgba, 0xff1111ff_rgba,
                                                 0x10000ff_rgba};
  ...
  const std::array expected_greens{0xde0000ff_rgba, 0xfffdfdff_rgba, 0x000000FF_rgba, 0xff9393ff_rgba, 0x990000ff_rgba};
