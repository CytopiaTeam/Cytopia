...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener
{
  ...
  public void pressBackButton()
  {
    runOnUiThread(new Runnable() {
      @Override public void run() { SDLActivity.this.superOnBackPressed(); }
    });
  }
  ...
  /**
     ...
     */
  protected boolean onUnhandledMessage(int command, Object param) { return false; }
    ...
    if ((Build.VERSION.SDK_INT >= 19) && (command == COMMAND_CHANGE_WINDOW_STYLE))
    {
      ...
      if (data instanceof Integer)
      {
        ...
        boolean bFullscreenLayout =
            ((realMetrics.widthPixels == mSurface.getWidth()) && (realMetrics.heightPixels == mSurface.getHeight()));
  ...
  public static native void onNativeResize(int surfaceWidth, int surfaceHeight, int deviceWidth, int deviceHeight, int format,
                                           float rate);
  ...
  public void setOrientationBis(int w, int h, boolean resizable, String hint)
  {
    ...
    Log.v("SDL", "setOrientation() orientation=" + orientation + " width=" + w + " height=" + h + " resizable=" + resizable +
                     " hint=" + hint);
    if (orientation != -1)
    {
  ...
  public static boolean getManifestEnvironmentVariables()
  {
    try
    {
      ApplicationInfo applicationInfo =
          getContext().getPackageManager().getApplicationInfo(getContext().getPackageName(), PackageManager.GET_META_DATA);
                                      ...
                                      final int[] buttonIds, final String[] buttonTexts, final int[] colors)
  {
    ...
    runOnUiThread(new Runnable() {
      @Override public void run() { showDialog(dialogs++, args); }
    });
  ...
  @Override protected Dialog onCreateDialog(int ignore, Bundle args)
  {
    ...
    dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
      @Override public void onDismiss(DialogInterface unused)
      {
  ...
  /**
     * This method is called by SDL using JNI.
     */
  public static boolean clipboardHasText() { return mClipboardHandler.clipboardHasText(); }

  /**
     * This method is called by SDL using JNI.
     */
  public static String clipboardGetText() { return mClipboardHandler.clipboardGetText(); }
...
*/
class SDLSurface
    extends SurfaceView implements SurfaceHolder.Callback, View.OnKeyListener, View.OnTouchListener, SensorEventListener
{
  ...
  public void handlePause() { enableSensor(Sensor.TYPE_ACCELEROMETER, false); }
  ...
  public Surface getNativeSurface() { return getHolder().getSurface(); }
...
class SDLClipboardHandler_API11 implements SDLClipboardHandler, android.content.ClipboardManager.OnPrimaryClipChangedListener
{
  ...
  @Override public boolean clipboardHasText() { return mClipMgr.hasText(); }

  @Override public String clipboardGetText()
  {
    CharSequence text;
  ...
  @Override public void clipboardSetText(String string)
  {
  ...
  @Override public void onPrimaryClipChanged() { SDLActivity.onNativeClipboardChanged(); }
}
...
class SDLClipboardHandler_Old implements SDLClipboardHandler
{
  ...
  @Override public boolean clipboardHasText() { return mClipMgrOld.hasText(); }
  ...
  @Override public void clipboardSetText(String string) { mClipMgrOld.setText(string); }
}
